...
if DateTime.IsHalloween then
	...
	ProducedUnitTypes =
	{
		...
		{ factory = SovietBarracks1, types = { "vice" } },
		{ factory = SovietBarracks2, types = { "vice" } },
		{ factory = SovietBarracks3, types = { "vice" } },
		{ factory = AlliedWarFactory1, types = { "hmmv", "gapc", "2tnk.gdi", "mrls", "4tnk.gdi.rail" } },
		{ factory = SovietWarFactory1, types = { "1tnk.nod", "bggy", "arty.nod", "stnk.nod", "bike" } }
	}
else
	UnitTypes = { "1tnk.nod", "stnk.nod", "ftnk", "bggy" }
	BeachUnitTypes = { "e1", "e1", "e3", "e5", "e1", "e1", "e3", "e5", "e1", "e3", "e3", "e5", "e1", "e1", "e3", "e5" }
	ProxyType = "powerproxy.paratroopers"
	ProducedUnitTypes =
	{
		{ factory = AlliedBarracks1, types = { "e1", "e3" } },
		{ factory = AlliedBarracks2, types = { "e1", "e3" } },
		{ factory = SovietBarracks1, types = { "infl", "e1", "terr", "e3", "e5", "cybr" } },
		{ factory = SovietBarracks2, types = { "infl", "e1", "terr", "e3", "e5", "cybr" } },
		{ factory = SovietBarracks3, types = { "infl", "e1", "terr", "e3", "e5", "cybr" } },
		{ factory = AlliedWarFactory1, types = { "hmmv", "gapc", "2tnk.gdi", "mrls", "4tnk.gdi.rail" } },
		{ factory = SovietWarFactory1, types = { "1tnk.nod", "bggy", "arty.nod", "stnk.nod", "bike" } }
	}
end

ShipUnitTypes = { "gapc", "mrpg", "hmmv", "2tnk.gdi", "2tnk.gdi" }
